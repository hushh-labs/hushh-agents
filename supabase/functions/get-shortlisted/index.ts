...
serve(async (req) => {
  ...
  for (const i of interactions) {
    if (i.action === "unsave") unsavedIds.add(i.agent_id);
    if (i.action === "save" && !unsavedIds.has(i.agent_id)) {
      savedIds.add(i.agent_id);
      if (!savedAt[i.agent_id]) savedAt[i.agent_id] = i.created_at;
    }
    if (i.action === "contact_request") contactedIds.add(i.agent_id);
  }

  /* ── map to full agent catalog ── */
  const catalog = getAgentCatalog();
  const results = [];

  for (const id of savedIds) {
    const agent = catalog.find((a: any) => a.id === id);
    if (!agent) continue;

    const status = contactedIds.has(id) ? "Contacted" : "Saved";
    results.push({ ...agent, status, savedAt: savedAt[id] });
  }
...
function getAgentCatalog() {
  return [
    ...
    { id: "60i_PglouDRdQ7Y2CWg0EQ", name: "Capital Planning", category: "Investing", rating: 5.0, reviewCount: 4, city: "Bellevue", state: "WA", address: "10900 NE 4th St, Ste 2300", phone: "(425) 643-1800", photoUrl: "https://s3-media0.fl.yelpcdn.com/bphoto/3n4Wsr34h37aS7Ji8DMlkA/o.jpg", services: ["Investment Management","Wealth Management"], bio: "Since 1983, providing wealth management solutions.", website: "https://www.capplanllc.com", hours: "Mon-Fri 7:30am-4pm", yearEstablished: 1983, specialties: null, representative: { name: "Michael M.", role: "business_owner", bio: "Helping executive clients." }, locallyOwned: false, certified: false, messagingEnabled: false, messagingText: null, responseTime: null },
    ...
    { id: "P4vPLVOYnfu0AzwhGv2IBw", name: "Huddleston Tax CPAs", category: "Accountants", rating: 3.9, reviewCount: 19, city: "Bellevue", state: "WA", address: "40 Lake Bellevue, Ste 100", phone: "(206) 310-8363", photoUrl: "https://s3-media0.fl.yelpcdn.com/bphoto/BwvPHsF0zObh6hHRlafGGA/o.jpg", services: ["Accounting","Tax Services","Financial Advising"], bio: "John Huddleston, CPA — focus on tax needs of small businesses.", website: "https://huddlestontaxcpas.com/locations/bellevue", hours: "Mon-Fri 9am-5pm", yearEstablished: 2002, specialties: null, representative: { name: "John H.", role: "business_owner", bio: "Masters in Tax Law from UW." }, locallyOwned: false, certified: false, messagingEnabled: true, messagingText: "Request information", responseTime: "50 mins" },
    { id: "jJVfV0bpp-t4vhbMBqndPg", name: "Omega Financial & Insurance", category: "Insurance", rating: 5.0, reviewCount: 2, city: "Kirkland", state: "WA", address: "10827 NE 68th St S, Ste 200", phone: "(425) 822-5722", photoUrl: "https://s3-media0.fl.yelpcdn.com/bphoto/bDjBj-By-bn7cgigAlJq9Q/o.jpg", services: ["Insurance","Financial Advising"], bio: "Comprehensive insurance and financial planning.", website: null, hours: null, yearEstablished: null, specialties: null, representative: null, locallyOwned: false, certified: false, messagingEnabled: false, messagingText: null, responseTime: null },
    ...
    { id: "b16asns7tqatMZ8R2Rqc1A", name: "Green Financial", category: "Financial Advising", rating: 5.0, reviewCount: 1, city: "Kirkland", state: "WA", address: "11930 Slater Ave NE, Ste 100", phone: "(425) 821-1111", photoUrl: "", services: ["Financial Advising","Health Insurance","Life Insurance"], bio: "Financial advising, health insurance, and life insurance services.", website: null, hours: null, yearEstablished: null, specialties: null, representative: null, locallyOwned: false, certified: false, messagingEnabled: false, messagingText: null, responseTime: null },
    ...
    { id: "CYpZ6QZRfjPgTw0unYxabQ", name: "Blue Mountain Wealth Management", category: "Financial Advising", rating: 5.0, reviewCount: 2, city: "Monroe", state: "WA", address: "20026 209th Ave SE", phone: "(509) 301-8701", photoUrl: "https://s3-media0.fl.yelpcdn.com/bphoto/Lui3vi2ma_mVd8_hkX8teA/o.jpg", services: ["Virtual Consultations","Financial Planning","Retirement Planning","Inheritance Planning","Wealth Management","Estate Planning"], bio: "Truly personalized approach to financial success.", website: "https://bluemountainwealthmanagement.com", hours: null, yearEstablished: null, specialties: null, representative: null, locallyOwned: false, certified: false, messagingEnabled: false, messagingText: null, responseTime: null },
  ];
}
